        ...
        <form action="prosesRegis.php" method="post" enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="tgl-lahir" pattern="^(0[1-9]|[12][0-9]|3[01])/(0[1-9]|1[0-2])/\d{4}$" placeholder="dd/mm/yyyy" style="border: none;" required/></td>
                ...
                <tr>
                    <div class="button-container">
                        ...
                        <!-- <td style="padding-left: 50px;"><input type="button" name="button-kembali" id="button-kembali" value="Kembali"></td> -->
